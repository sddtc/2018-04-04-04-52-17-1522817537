...
#### by myself
1. test case : 输入1，返回界面：请输入学生信息（格式：姓名, 学号, 学科: 成绩, ...），按回车提交：
2. test case : 输入 姓名, 学号, 学科: 成绩， 正确： 输出 学生xxx的成绩被添加 然后打印systemout
3. test case : 输入 姓名, 学号, 学科: 成绩， 错误： 输出 请按正确的格式输入（格式：姓名, 学号, 学科: 成绩, ...）：